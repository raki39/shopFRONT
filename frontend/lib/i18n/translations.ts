export const translations = {
  'pt-br': {
    ...
    onboarding: {
      ...
      welcomeDesc: 'Este é seu assistente inteligente de análise de dados. Vamos fazer um tour rápido para você conhecer a plataforma.',
      agents: 'Seus Agentes de IA',
      agentsDesc: 'Aqui estão os agentes disponíveis. Cada agente possui habilidades específicas para responder suas perguntas sobre o negócio.',
      startConversation: 'Inicie uma Conversa',
      startConversationDesc: 'Clique em um card de agente para começar. Você será direcionado para o chat onde poderá fazer suas perguntas.',
      conversationHistory: 'Histórico de Conversas',
      ...
      newConversationDesc: 'Clique aqui para iniciar uma nova conversa com o agente. Cada conversa fica salva automaticamente.',
      askQuestion: 'Faça sua Pergunta',
      askQuestionDesc: 'Digite sua pergunta aqui em linguagem natural. O agente irá analisar seus dados e responder com insights.',
      settingsTitle: 'Configurações',
      settingsDesc: 'Acesse as configurações do sistema, gerencie conexões de banco de dados e personalize suas preferências.',
  ...
  'en': {
    ...
    onboarding: {
      ...
      welcomeDesc: "This is your intelligent data analysis assistant. Let's take a quick tour to help you get to know the platform.",
      agents: 'Your AI Agents',
      agentsDesc: 'Here are the available agents. Each agent has specific skills to answer your business questions.',
      startConversation: 'Start a Conversation',
      startConversationDesc: 'Click on an agent card to begin. You will be directed to the chat where you can ask your questions.',
      conversationHistory: 'Conversation History',
      conversationHistoryDesc: 'All your previous conversations are in this sidebar. You can access them at any time.',
      newConversation: 'New Conversation',
      newConversationDesc: 'Click here to start a new conversation with the agent. Each conversation is saved automatically.',
      askQuestion: 'Ask a Question',
      askQuestionDesc: 'Type your question here in natural language. The agent will analyze your data and respond with insights.',
      settingsTitle: 'Settings',
      settingsDesc: 'Access system settings, manage database connections and customize your preferences.',
